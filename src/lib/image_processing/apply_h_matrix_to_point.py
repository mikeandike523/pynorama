"""
A utility to apply a homography matrix to a given 2D point
combining the matrix multiplication and perspective division
steps into one funtion
"""
...
def apply_h_matrix_to_point(
    ...
    transformed_point = np.matmul(homography, point_homogeneous)
